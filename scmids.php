...
<h1 style="font-size:35px">Guidify</h1>
    ...
    <script>
      ...
      const courses = [
        { title: "Machine Learning", link: "machinelearning.php" },
        { title: "Data Structures using python", link: "dsusingpython.php" },
        { title: "Data Structures using R programming", link: "dsusingR.php" },
        { title: "DeepLearning", link: "deeplearning.php" },
        { title: "", link: "" },
        { title: "", link: "" },
        { title: "", link: "" },
        { title: "", link: "" },
