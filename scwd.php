...
<h1 style="font-size:35px">Guidify</h1>
    ...
    <script>
      ...
      const courses = [
        { title: "HTML,CSS&JAVASCRIPT", link: "htmlcsjs.php" },
        { title: "PHP", link: "PHP.php" },
        { title: "jquery", link: "jquery.php" },
        { title: "ReactJS", link: "Reactjs.php" },
        { title: "Node.JS", link: "node.php" },
        { title: "AngularJS", link: "angularjs.php" },
        { title: "JSON", link: "JSON.php" },
        { title: "", link: "" },
        ];
