...
<h1 style="font-size:35px">Guidify</h1>
    ...
    <script>
      ...
      const courses = [
        { title: "C", link: "l.html" },
        { title: "Python", link: "intro-to-javascript.html" },
        { title: "Java", link: "responsive-web-design.html" },
        { title: "C++", link: "python-programming-basics.html" },
        { title: "JavaScript", link: "data-science-fundamentals.html" },
        { title: "C# ", link: "react-native-app-development.html" },
        { title: "Ruby", link: "graphic-design-for-beginners.html" },
        {
          title: "Machine Learning Essentials",
          link: "machine-learning-essentials.html",
        },
      ];
