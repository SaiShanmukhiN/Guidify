	...
	<div class = "cour">
		...
		<div>
			<strong>Udemy</strong>
            		...
            		<br>
            		<span class="duration"><i class="fas fa-clock"></i> 29 hrs 33 min</span>
            		<br>
            	Rating: <span class="rating"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
            		...
            		<br>
            		<span class="website"><a href="https://www.udemy.com/course/the-complete-angular-master-class/?couponCode=IND21PM" target="_blank">Learn more</a></span>
        ...
        <li>
            <div class="cour">
                ...
                <strong>Edureka </strong>
                    ...
                    <br>
                    <span class="website"><a href="https://www.edureka.co/angular-training?utm_source=Google-Search&utm_medium=cpc&utm_campaign=ET-IND-Search-WebDevelopmentCluster-Angular-IN-Main-AllDevice&utm_term=9&gad_source=1&gclid=Cj0KCQjw-r-vBhC-ARIsAGgUO2DEvoiFmGodh0G5rSD6pWEyNxIhYK3d3f3jZObdT6pFFu23II2oGIQaAnz0EALw_wcB">Learn more</a></span>
                </div>
            </div>
        </li>
        ...
        <li>
            <div class="cour">
                <div class="c1">
                    <img src = "./zuan.jpg" width = "140px" heigth = "140px"/></div>
                <div>
                <div>
                    <strong>ZUAN Education</strong>
                    <br>
                    <span class="level">Intermediate</span>
                    <br>
                    <span class="duration"><i class="fas fa-clock"></i> 50 hrs</span>
                    <br>
                    Rating: <span class="rating"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
                    <br>
                    Amount: $157
                    ...
                    <span class="description">Donec tincidunt justo in diam tristique, id scelerisque lacus fringilla. Sed efficitur feugiat odio, eget hendrerit arcu consequat vel.</span>
                    <br>
                    <span class="website"><a href="https://www.zuaneducation.com/angular-js-training-courses">Learn more</a></span>
