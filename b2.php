...
.profile-circle {
  ...
  <body>
    ...
    <header>
    <h1 style="font-size:40px">Online Courses Catalog</h1>
  </header>
  ...
  <script>
    ...
    const courses = [
      { title: ' Programming Languages', link: 'scplup.php' },
      { title: 'Web Development', link: 'scwdup.php' },
      { title: 'Web Development In Python', link: 'data-science-fundamentals.html' },
      { title: 'Data Structures & Algorithms', link: 'responsive-web-design.html' },
      { title: 'ML & Data Science', link: 'python-programming-basics.html' },
      { title: 'DevOps', link: 'react-native-app-development.html' },
      { title: 'Databases', link: 'graphic-design-for-beginners.html' },
      { title: 'Software Testing', link: 'machine-learning-essentials.html' },
    ];
